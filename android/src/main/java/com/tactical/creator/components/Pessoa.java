...
//            need to inforce the pivot for some reason
        ...
        CustomAnimation.justDoIt(context, myImage, arrayPosition, screenHeight, screenWidth, velocity, (float) player.getInt("rotation"), (CustomAnimation.convertDpToPixels(-2.0f,context) * scale),(CustomAnimation.convertDpToPixels(2.0f,context) * scale));

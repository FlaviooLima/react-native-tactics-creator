...
public class FieldBgRectangle {
    ...
    public void create(ImageView field_lines_image, Integer screenFieldHeight, Integer screenFieldWidth) {
        ...
        try {
            ...
            canvas.save();
            path_0.reset();
            path_0.moveTo(868.299988f, 12.500000f);
            path_0.lineTo(868.299988f, 564.600037f);
            path_0.lineTo(37.700001f, 564.600037f);
            path_0.lineTo(37.700001f, 12.500000f);
            path_0.lineTo(868.299988f, 12.500000f);
            path_0.moveTo(869.799988f, 11.000000f);
            path_0.lineTo(36.200001f, 11.000000f);
            path_0.lineTo(36.200001f, 566.000000f);
            path_0.lineTo(869.700012f, 566.000000f);
            path_0.lineTo(869.799988f, 11.000000f);
            path_0.lineTo(869.799988f, 11.000000f);
            path_0.close();

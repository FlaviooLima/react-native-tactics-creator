...
public class FieldBgTriangle {
    ...
    public void create(ImageView field_lines_image, Integer screenFieldHeight, Integer screenFieldWidth) {
        ...
        try {
            ...
            canvas.save();
            path_0.reset();
            path_0.moveTo(756.600037f, 528.500000f);
            path_0.lineTo(149.400009f, 528.500000f);
            path_0.lineTo(150.300003f, 527.099976f);
            path_0.lineTo(453.000000f, 48.500000f);
            path_0.lineTo(756.600037f, 528.500000f);
            path_0.close();
            path_0.moveTo(152.699997f, 526.700012f);
            path_0.lineTo(753.300049f, 526.700012f);
            path_0.lineTo(453.000000f, 51.900002f);
            path_0.lineTo(152.699997f, 526.700012f);
            path_0.close();
